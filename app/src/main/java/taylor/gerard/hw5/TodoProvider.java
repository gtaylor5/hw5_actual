...
public class TodoProvider extends ContentProvider {
    ...
    public static final int DB_VERSION = 6;                 // current database version
            ...
            try {
                ...
                switch(oldVersion) {
                    ...
                    case 1:
                        ...
                        db.execSQL(String.format("alter table %s add %s integer", TODO_TABLE, PRIORITY));
                    ...
                    case 4:
                        // do upgrades from version 2 -> version 3
                        db.execSQL(String.format("alter table %s add %s text", TODO_TABLE, DUEDATE));
                        // FALL THROUGH TO APPLY FURTHER UPGRADES
